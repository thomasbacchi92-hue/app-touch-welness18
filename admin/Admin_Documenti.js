/* Admin_Documenti.js - Core Logic per Documenti Cloud e Generazione v4.4 - ELIMINAZIONE AGGIUNTA */
...
window.docApp = {
    ...
    init: function() {
        ...
        firebase.database().ref('MASTER_ADMIN_DB/structures').once('value').then(snap => {
