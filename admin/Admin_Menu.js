/* Admin_Menu.js - Menu Dinamico Direzionale Master v16.0 */
...
window.injectAdminMenu = function() {
    ...
    <div class="sidebar" id="adminSidebar">
        ...
        <div id="optionsSubMenu" style="display:${isDocPage ? 'flex' : 'none'}; flex-direction:column; padding-left:10px; margin-left:15px; border-left:2px solid var(--border-line);">
            ...
            <div class="nav-item" id="nav-privacy" onclick="if(typeof app !== 'undefined'){app.switchView('privacy'); document.getElementById('sidebarOverlay').click();}else{window.location.href='admin.html'}" style="padding:10px; font-size:12px;"><i class="material-icons-round" style="font-size:16px;">verified_user</i> Privacy Drive</div>
